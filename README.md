...
- Storybook uses [`@storybook/react-vite`](./package.json) for isolated UI review. Stories live next to components as `*.stories.tsx`; run `pnpm storybook` for local review and `pnpm build-storybook` before sharing a static Storybook artifact.

...
No hosted migration, deployment, push, or review-thread resolution was performed during this hardening work. Before hosted application of the unique index, check for existing duplicate unfinished attempts; the migration deliberately fails rather than silently deleting data.

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b53eabc59d699ff381f74c3fc57d64d2)
// Runtime types generated with workerd@1.20260910.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	ASSESSMENT_ATTEMPT_RATE_LIMITER: RateLimit;
	ASSESSMENT_ACTIVITY_RATE_LIMITER: RateLimit;
	DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "DATABASE_URL_POOLED" | "USE_HYPERDRIVE" | "R2_BUCKET_NAME" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
